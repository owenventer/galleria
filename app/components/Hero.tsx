    ...
    return (
      <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        ...
        <div className="text-center">
          ...
          <div className="mt-16">
            <a
              href="https://www.google.com/search?q=helius+das+api&rlz=1C5CHFA_enUS964US964&oq=helius+&gs_lcrp=EgZjaHJvbWUqDggAEEUYJxg7GIAEGIoFMg4IABBFGCcYOxiABBiKBTIOCAEQRRgnGDsYgAQYigUyBggCEEUYOTIGCAMQRRg7MgYIBBBFGDwyBggFEEUYPDIGCAYQRRg8MgYIBxBFGDyoAgCwAgA&sourceid=chrome&ie=UTF-8"
              target="_blank"
              rel="noopener noreferrer"
